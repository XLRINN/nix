...
# Powerlevel10k theme
source /Users/david/nix/modules/config/shell/p10k.zsh
...
# Aliases
alias pf="pfetch"
alias bs="nix run .#swap"                                # build + switch (requires sudo now, see sbs)
alias bss="nix run .#swap && source ~/.zshrc"             # build + switch + reload
alias fmu="clear && nix run .#swap && source ~/.zshrc"    # full update

# Sudo variants (preferred on nix-darwin since activation must run as root)
alias sbs="sudo -H nix run .#swap"
alias sbss="sudo -H nix run .#swap && source ~/.zshrc"
alias sfmu="clear && sudo -H nix run .#swap && source ~/.zshrc"
alias sauce="source ~/.zshrc"
alias addcask="nvim ~/nix/modules/darwin/casks.nix"
alias cbs="clear && bs"
alias gc="nix-collect-garbage -d"
alias pretty="POWERLEVEL9K_CONFIG_FILE=/tmp/p10k.zsh p10k configure && cp ~/.p10k.zsh nix/modules/config/shell/p10k.zsh"
alias pretty2="cp ~/.p10k.zsh nix/modules/config/shell/p10k.zsh"

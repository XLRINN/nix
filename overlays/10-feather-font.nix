# Feather font overlay - currently disabled due to broken source
...
#
#     src = fetchzip {
#       url = "https://github.com/xlrinn/feather-font/archive/refs/tags/${version}.zip";
...
# Empty overlay to prevent build errors
self: super: {}
